...
TRANSLATIONS = {
    ...
    "pt": {
        ...
        "| I want to prepare for the MCP Associate (MCPA) | [MCPA onboarding](certifications/mcpa/GETTING_STARTED.md) | [MCPA track](https://aiengineeringfromscratch.com/certification?id=mcpa-f) |": "| Quero me preparar para a certificação MCP Associate (MCPA) | [Introdução ao MCPA](certifications/mcpa/GETTING_STARTED.md) | [Trilha MCPA](https://aiengineeringfromscratch.com/certification?id=mcpa-f) |",
    ...
    "ru": {
        ...
        "| I want to prepare for the MCP Associate (MCPA) | [MCPA onboarding](certifications/mcpa/GETTING_STARTED.md) | [MCPA track](https://aiengineeringfromscratch.com/certification?id=mcpa-f) |": "| Я хочу подготовиться к сертификации MCP Associate (MCPA) | [Начало подготовки к MCPA](certifications/mcpa/GETTING_STARTED.md) | [Маршрут MCPA](https://aiengineeringfromscratch.com/certification?id=mcpa-f) |",
