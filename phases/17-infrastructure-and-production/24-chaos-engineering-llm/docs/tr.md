...
4. **Kötü biçimlendirilmiş prompt** — tokenizer'yi durduran veriyi (e.g., derinlemesine yuvalanmış unicode, büyük UTF-8 kod noktası) enjekte edin. Gözlemleyin: Tek bir istek bir çalışanı kilitler mi?
...
İlk deney: Sabit trafik altında bir kod çözme kopyasını kapsülle sonlandırın. Yeniden yönlendirmeyi ve kurtarmayı gözlemleyin. Eğer bu işe yararsa ve güvenli görünüyorsa, ağ kaosuna geçiş yapın.
...
- Dört düzlem: kontrol, hedef, güvenlik, observability.
...
Bu ders `outputs/skill-chaos-plan.md`'yi üretir. Yığın ve olgunluk göz önüne alındığında, ilk üç deneyi ve araçları seçer.

## Egzersizler

1. `code/main.py`'yi çalıştırın. Hangi deney yanma hızı kapısını tetikliyor ve neden?
...
| Hatalı Biçimlendirilmiş prompt | "tokenizer bomba" | tokenization'ı durduran giriş |
...
- [Ankush Sharma — Yüksek Lisans Dereceleri için Observability (kitap)](https://www.amazon.com/Observability-Large-Language-Models-Engineering-ebook/dp/B0DJSR65TR)
- [LitmusKaos (CNCF)](https://litmuschaos.io/)
- [Kaos Ağı (CNCF)](https://chaos-mesh.org/)
- [Kaos Mühendisliğini Harness](https://www.harness.io/products/chaos-engineering)
