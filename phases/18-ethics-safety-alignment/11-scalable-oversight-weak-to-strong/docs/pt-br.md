...
- Descrever o setup experimental de Burns et al. 2023: fine-tune de GPT-4 usando labels de GPT-2.
...
Baselines: acurácia do próprio modelo fraco, teto supervisionado do modelo forte com labels gold.
...
Lang et al. — Debate Helps Weak-to-Strong Generalization (arXiv:2501.13124) combina os dois: um protocolo de debate fornece melhores labels fracas, e o modelo forte é treinado com esses labels. Ganhos de PGR reportados em tarefas de NLP.
...
`code/main.py` simula um fine-tune W2SG em uma tarefa sintética. O rotulador fraco tem 70% de acurácia com erros estruturados; o modelo forte tem teto de 95% com labels gold. Você faz fine-tune do modelo forte com labels fracas, mede PGR, e compara com forte-gold e fraco-sozinho.
...
3. Leia Burns et al. 2023 Seção 4.3 (tarefas de NLP). Reproduza a intuição de "confiança auxiliar loss": quando o modelo forte é mais confiante que as labels fracas, quem vence?
...
| W2SG | "fraco supervisiona forte" | Fine-tune de um modelo forte com labels fracas medendo a capacidade recuperada |
...
- [Leike et al. — Scalable agent alignment via reward modeling (arXiv:1811.07871)](https://arxiv.org/abs/1811.07871) — modelagem recursativa de recompensa
