---
name: topic-picker
描述： Pick LDA or BERTopic for a corpus. Specify library, knobs, evaluation.
版本： 1.0.0
阶段： 5
课程： 15
...
给定 a corpus description (document count, avg length, domain, language, compute budget), output:
