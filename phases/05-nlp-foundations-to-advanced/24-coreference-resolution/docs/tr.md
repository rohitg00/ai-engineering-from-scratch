...
300 kelimelik bir makaleden Apple Inc.'in bahsettiği her şeyi çıkarın. Makalede "Apple" dendiğinde kolay. "Şirket", "onlar", "Cupertino'nun teknoloji devi" veya "Jobs'un firması" derken zor. Bu bahisleri aynı varlığa çözümlemediğiniz takdirde NER boru hattınız bahsi geçenlerin %60-80'ini kaçırır.
...
![Bağlantılı referans kümeleme: bahseder → varlıklar](../assets/coref.svg)
...
5. **Generative (2024+).** Prompt ve LLM: "Bu metindeki her zamiri ve öncüllerini listeleyin." Kolay vakalarda iyi çalışır, uzun belgelerde ve nadir referanslarda zorluk çeker.

**Değerlendirme metrikleri.** Beş standart metrik (MUC, B³, CEAF, BLANC, LEA) çünkü kümeleme kalitesini tek başına ölçen bir ölçü yoktur. İlk üçün ortalamasını CoNLL F1 olarak bildirin. CoNLL-2012'de 2026'daki son teknoloji: ~83 F1.
...
Yalnızca stdlib uygulaması için `code/main.py`'ye bakın:
...
- **Uzun bağlamda zamirler.** 2.000 token'nin üzerindeki belgelerde performans ~15 F1 düşer. Dikkatlice parçalayın.
...
| Hızlı Yüksek Lisans temel çizgisi | GPT-4o / Claude, yapısal çıkış çekirdeği prompt ile |
...
1. **Kolay.** `code/main.py`'deki kural tabanlı çözümleyiciyi 5 el yapımı paragrafta çalıştırın. Bahsetme bağlantısının doğruluğunu temel gerçeğe göre ölçün.
...
- [Jurafsky ve Martin, SLP3 Bölüm. 26 — Referans Çözünürlüğü ve Varlık Bağlantısı](https://web.stanford.edu/~jurafsky/slp3/26.pdf) — standart ders kitabı bölümü.
- [Lee ve ark. (2017). Uçtan Uca Sinirsel Referans Çözünürlüğü](https://arxiv.org/abs/1707.07045) — uçtan uca yayılma tabanlı.
- [Joshi ve ark. (2020). SpanBERT](https://arxiv.org/abs/1907.10529) — coref'i geliştiren ön eğitim.
- [Pradhan ve diğerleri. (2012). CoNLL-2012 Paylaşılan Görev](https://aclanthology.org/W12-4501/) — benchmark.
-[Hobbs (1978). Zamir Referanslarını Çözümleme](https://www.sciencedirect.com/science/article/pii/0024384178900064) — kurala dayalı klasik.
