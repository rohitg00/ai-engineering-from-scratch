---
name: seq2seq-design
描述： Design a sequence-to-sequence pipeline for a given task.
阶段： 5
课程： 09
---

给定 a task (translation, summarization, paraphrase, question rewrite), output:
...
Refuse to 推荐 training a seq2seq from scratch for under ~1M parallel examples. Flag any pipeline using greedy decoding for user-facing content as fragile (greedy repeats and loops).
