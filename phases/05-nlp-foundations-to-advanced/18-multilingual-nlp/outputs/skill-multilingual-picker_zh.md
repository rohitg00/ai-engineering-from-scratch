...
描述： Pick source language, target model, and evaluation plan for a multilingual NLP task.
版本： 1.0.0
阶段： 5
课程： 18
标签： [nlp, multilingual, cross-lingual]
---

给定 requirements (target languages, task type, available labeled data per language), output:
