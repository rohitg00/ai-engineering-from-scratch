...
- Sentimento baseado em aspecto. "Camera was great but battery was terrible." Você precisa atribuir sentimento a aspectos. Só transformers ou modelos de saída estruturada.
...
| Sentimento baseado em aspecto | Polaridade por aspecto | Atribui sentimento a entidades ou atributos específicos mencionados no texto. |
...
- [scikit-learn text feature extraction docs](https://scikit-learn.org/stable/modules/feature_extraction.html#text-feature-extraction) — referência pra `CountVectorizer`, `TfidfVectorizer`, e cada parâmetro que você vai ajustar.
