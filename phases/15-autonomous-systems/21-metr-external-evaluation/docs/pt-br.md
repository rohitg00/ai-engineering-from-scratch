...
O horizonte é o teto de capacidade sob condições favoráveis. Confiabilidade de deploy é um número diferente, menor, e equipes devem medir sua própria distribuição para conhecê-lo.
...
| Eval-context gaming | "Modelo se comporta diferente" | Lacuna de comportamento documentada entre testes e deploy |
| Limite superior | "Horizonte é um teto" | Horizonte de benchmark > confiabilidade de deploy sob carga |

## Leituras Adicionais

- [METR — Resources for Measuring Autonomous AI Capabilities](https://metr.org/measuring-autonomous-ai-capabilities/) — especificações de HCAST, RE-Bench, SWAA.
...
- [Anthropic — Measuring agent autonomy in practice](https://www.anthropic.com/research/measuring-agent-autonomy) — perspectiva interna sobre medições da METR.
