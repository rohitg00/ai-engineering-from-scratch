...
(function () {
  ...
  function createPaletteDOM() {
    ...
    el.setAttribute('aria-label', 'Derslerde ve sözlükte ara');
  ...
  function renderResults(results) {
    ...
    if (!query) {
      list.innerHTML =
        ...
        '503 ders, 499 çıktı ve sözlük terimi içinde aramak için yazın' +
        '</li>';
      _activeIdx = -1;
      return;
    }
    ...
    for (var i = 0; i < results.length; i++) {
      ...
      if (r.kind === 'lesson') {
        ...
        dest = r.lessonPath
          ...
          : r.url;
        chip = 'Aşama ' + String(r.phaseId).padStart(2, '0');
      ...
      if (r.kind === 'lesson') {
        ...
        if (r.phaseId !== undefined && r.phaseId !== null) {
          metaParts.push('Aşama ' + String(r.phaseId).padStart(2, '0'));
        }
      }
