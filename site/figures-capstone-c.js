(function () {
  ...
  function embeddingLookup(host) {
    ...
    tg.appendChild(anim('opacity', '0;0;1', '3s', { keyTimes: '0;0.55;0.75', fill: 'freeze' }));
    svg.appendChild(tg);
    ...
    sumg.appendChild(anim('opacity', '0;0;1', '3s', { keyTimes: '0;0.7;0.9', fill: 'freeze' }));
  ...
  function hdf5Buffer(host) {
    ...
    fill.appendChild(anim('width', '0;' + (bw - 2) + ';' + (bw - 2) + ';0', '3.2s', { keyTimes: '0;0.5;0.6;0.62' }));
    ...
    for (cyc = 0; cyc < chunks; cyc++) {
      ...
      if (cyc === chunks - 1) {
        ...
        c.appendChild(anim('opacity', '0;0.12;0.5', '3.2s', { keyTimes: '0;0.55;0.7', fill: 'freeze' }));
      }
      svg.appendChild(c);
    }
  ...
  function gradAccum(host) {
    ...
    fill.appendChild(anim('width', '0;' + (gw / 4) + ';' + (gw / 2) + ';' + (3 * gw / 4) + ';' + (gw - 2) + ';0', '4s', { keyTimes: '0;0.2;0.4;0.6;0.85;0.9' }));
    svg.appendChild(fill);
    var i;
    for (i = 0; i < n; i++) {
      var x = x0 + i * (bw + gap);
  ...
  function atomicCheckpoint(host) {
    ...
    fin.appendChild(anim('opacity', '0.2;0.2;1', '2.4s', { keyTimes: '0;0.55;0.75', fill: 'freeze' }));
    svg.appendChild(fin);
