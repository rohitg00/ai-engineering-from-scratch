...
(function () {
  ...
  function sleeperTrigger(host) {
    ...
    for (i = 0; i < 3; i++) {
      ...
      sw.appendChild(anim('opacity', '0;0.35;0.35;0', '6s', { begin: (i * 1.1) + 's', keyTimes: '0;0.03;0.15;0.2' }));
      svg.appendChild(sw);
  ...
  function schemingProbe(host) {
    ...
    read.appendChild(anim('stroke-dashoffset', '36;0', '6s', { begin: '0.7s', keyTimes: '0;0.25' }));
    ...
    act.appendChild(anim('opacity', '0;0;1;1;0', '6s', { begin: '0.7s', keyTimes: '0;0.6;0.64;0.8;0.85' }));
    svg.appendChild(act);
  ...
  function guardStack(host) {
    ...
    for (i = 0; i < 3; i++) {
      ...
      dart.appendChild(anim('opacity', '0;1;1;0', '3.6s', { begin: (0.6 + i * 0.35) + 's', keyTimes: '0;0.08;0.3;0.42' }));
      dart.appendChild(anim('y2', '48;88', '3.6s', { begin: (0.6 + i * 0.35) + 's', keyTimes: '0;0.3', calcMode: 'spline', keySplines: SPL }));
    ...
    flash.appendChild(anim('opacity', '0;0;0.9;0', '3.6s', { keyTimes: '0;0.4;0.5;0.7' }));
