...
(function () {
  ...
  function objectDetectionNms(host) {
    ...
    lab.appendChild(anim('opacity', '0;0;1', '5s', { keyTimes: '0;0.6;0.78' }));
    svg.appendChild(lab);
    ...
    lt.appendChild(anim('opacity', '0;0;1', '5s', { keyTimes: '0;0.6;0.78' }));
    svg.appendChild(lt);
  ...
  function segmentationFlood(host) {
    ...
    var mp = svgEl('animateMotion', { dur: '4s', repeatCount: 'indefinite', path: 'M 175 70 C 240 30, 300 30, 330 70', keyTimes: '0;0.5;1', values: '' });
    mp.setAttribute('keyPoints', '0;1;1');
    mp.setAttribute('keyTimes', '0;0.5;1');
    dot.appendChild(mp);
    svg.appendChild(dot);
  ...
  function nerfRays(host) {
    ...
    for (i2 = 0; i2 < 3; i2++) {
      ...
      px.appendChild(anim('opacity', '0;0;0.85', '4s', { begin: (i2 * 0.25) + 's', keyTimes: '0;0.7;0.9' }));
      svg.appendChild(px);
    }
