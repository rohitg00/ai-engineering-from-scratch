...
(function () {
  ...
  function proposeThenCommit(host) {
    ...
    stages.forEach(function (st, i) {
      var active = svgEl('rect', { x: st.x, y: 80, width: 90, height: 50, rx: 4, fill: 'none', stroke: SOFT, 'stroke-width': 1.6 });
      active.appendChild(anim('stroke', SOFT + ';' + BP + ';' + SOFT, '6.4s', { begin: (i * 1.6) + 's' }));
