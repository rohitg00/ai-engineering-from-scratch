...
(function () {
  ...
  function asrAttention(host) {
    ...
    toks.forEach(function (t, k) {
      ...
      band.appendChild(anim({ attributeName: 'opacity', values: '0;0;0.28;0.28;0', keyTimes: ['0', (0.12 + k * 0.2).toFixed(2), (0.22 + k * 0.2).toFixed(2), (0.3 + k * 0.2).toFixed(2), (0.4 + k * 0.2).toFixed(2)].join(';'), dur: '6s', repeatCount: 'indefinite' }));
  ...
  function voiceFactorize(host) {
    ...
    spkA.appendChild(anim({ attributeName: 'opacity', values: '0;0;0.8;0.8;0.25', keyTimes: '0;0.18;0.3;0.45;0.55', dur: '6s', repeatCount: 'indefinite' }));
    ...
    swap.appendChild(anim({ attributeName: 'opacity', values: '0;0;0.9;0.9;0', keyTimes: '0;0.45;0.55;0.7;0.8', dur: '6s', repeatCount: 'indefinite' }));
