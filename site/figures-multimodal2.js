...
(function () {
  ...
  function actionTokens(host) {
    ...
    samples.forEach(function (si, k) {
      ...
      dot.appendChild(anim('cy', cy.toFixed(1) + ';' + cy.toFixed(1) + ';' + binned.toFixed(1) + ';' + binned.toFixed(1), '0;0.4;0.6;1', '3.2s', { begin: bg }));
      dot.appendChild(anim('fill', B + ';' + B + ';' + W + ';' + W, '0;0.4;0.6;1', '3.2s', { begin: bg }));
      svg.appendChild(dot);
    });
