  ...
  },
  {
    ...
    "lessons": [
      ...
      },
      {
        ...
        "summary": "A ReAct loop written by hand is a \"while True\". A ReAct loop written in LangGraph is a graph you can checkpoint, interrupt, branch, and time-travel through. The agent hasn't changed. The harness around it has.",
        "keywords": "StateGraph nodes and edges · The four superpowers · Reducers and add_messages · ReAct graph in four nodes · StateGraph vs Send · Subgraphs · Human-in-the-loop · Time-travel debugging"
      },
      {
        "name": "Agent Framework Trade-offs",
        "status": "complete",
        "type": "Learn",
        "lang": "Python",
        ...
        "summary": "Every framework sells the same demo (research agent builds a report) and hides the same bug (state schema fights with the orchestration layer). Pick the framework whose abstractions match the shape of your problem; everything else is glue you write twice.",
        "keywords": "Agent framework matrix · The state question · The branching question · Observability · Cost and latency · Decision Matrix"
      }
      }
    ]
  },
