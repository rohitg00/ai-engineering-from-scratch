(function () {
  ...
  function nliRouter(host) {
    ...
    labs.forEach(function (l, i) {
      ...
      var box = svgEl('rect', { x: ex - 6, y: ey - 15, width: 96, height: 26, rx: 4, fill: i === 0 ? BP : 'none', stroke: i === 0 ? BP : RULE, 'stroke-width': '1.5' });
      box.appendChild(anim('fill', i === 0 ? (BP + ';' + BP + ';' + RULE + ';' + RULE + ';' + BP) : (RULE + ';' + RULE + ';' + BP + ';' + RULE + ';' + RULE), 6, { begin: '0', keyTimes: i === 0 ? '0;0.5;0.55;0.95;1' : '0;' + (0.5 + i * 0.005) + ';0.55;0.6;1' }));
      svg.appendChild(box);
