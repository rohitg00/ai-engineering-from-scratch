...
(function () {
  ...
  function boundedGates(host) {
    ...
    x1.appendChild(anim('opacity', { values: '0;0;1;0', dur: '5s', keyTimes: '0;0.45;0.55;0.75', begin: '1.2s' }));
    svg.appendChild(x1);
  ...
  function costGovernorStack(host) {
    ...
    bar.appendChild(anim('fill', { values: BP + ';' + BP + ';' + WARN, dur: '4s', keyTimes: '0;0.68;0.72', fill: 'freeze' }));
    svg.appendChild(bar);
  ...
  function circuitBreaker(host) {
    ...
    var lt = svgEl('animateTransform', { attributeName: 'transform', type: 'rotate', dur: '4.5s', repeatCount: 'indefinite', values: '0 ' + bx + ' ' + (by - 44) + ';0 ' + bx + ' ' + (by - 44) + ';48 ' + bx + ' ' + (by - 44), keyTimes: '0;0.62;0.72' });
    lever.appendChild(lt);
    lever.appendChild(anim('stroke', { values: BP + ';' + BP + ';' + WARN, dur: '4.5s', keyTimes: '0;0.62;0.72' }));
    ...
    st.appendChild(anim('opacity', { values: '0;0;1', dur: '4.5s', keyTimes: '0;0.7;0.78', fill: 'freeze' }));
    svg.appendChild(st);
  ...
  function checkpointReplay(host) {
    ...
    arc.appendChild(anim('opacity', { values: '0;0;1;1;0', dur: '6s', keyTimes: '0;0.46;0.5;0.7;0.8' }));
    svg.appendChild(arc);
