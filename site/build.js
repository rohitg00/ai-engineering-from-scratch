...
function writeBuildMeta() {
  ...
  if (!repository) repository = 'rohitg00/ai-engineering-from-scratch';
  const js = '// Auto-generated by build.js on each deploy — do not edit.\n'
    + 'window.__AIFS_BUILD_META = ' + JSON.stringify({ ref, repository }) + ';\n'
    + 'window.__AIFS_REF = window.__AIFS_BUILD_META.ref;\n'
    + 'window.__AIFS_REPOSITORY = window.__AIFS_BUILD_META.repository;\n';
