(function () {
  ...
  function ceMigrationFunnel(host) {
    ...
    hard.appendChild(svgEl('animateMotion', { dur: '6s', repeatCount: 'indefinite', begin: '0.5s', path: 'M104 120 L250 120 C290 124,306 148,316 168', calcMode: 'linear', keyPoints: '0;0.55;0.55;1', keyTimes: '0;0.3;0.4;0.55' }));
    ...
    okOut.appendChild(anim('opacity', '0;0;1;1;0', '6s', { keyTimes: '0;0.62;0.66;0.8;0.84' }));
    ...
    failOut.appendChild(anim('opacity', '0;0;1;1;0', '6s', { keyTimes: '0;0.78;0.82;0.94;0.98' }));
  ...
  function ceOtelDrift(host) {
    ...
    drop.appendChild(anim('opacity', '0;0;1;0', '6s', { keyTimes: '0;0.32;0.42;0.5' }));
